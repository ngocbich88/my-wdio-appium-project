...
<head>
  ...
  <script type="text/javascript">
    console.log('Hello from Appium');
    console.log('Loading guinea-pig page');
    console.log('Done');
    if ('<%= throwError %>') {
      throw new Error('JavaScript Error: <%= throwError %>');
    }
  </script>
</head>
<body>
...
<a href="/tests/guinea-pig2.html" id="i am a link">i am a link</a><br/>
<a href="#anchor" id="i am an anchor link">i am an anchor link</a><br/>
<a href="/tests/guinea-pig2.html?newwindow=blanklink" id="blanklink" target="_blank">i am a new window link</a>
<a href="/tests/guinea-pig3.html" id="guinea pig 3 link">i am a link to page 3</a><br/>
<a href="/tests/guinea-pig4.html" id="guinea pig 4 blank link" target="_blank">i am a new window link to page 4</a>
